                ...
                <div className="w-full max-w-xs">
                    <form action={action} className={cx("flex flex-col gap-6" )}>
                        ...
                        <div className="grid gap-6">
                            ...
                            <span className="relative z-10 bg-background px-2 text-foreground/30">
                                Or continue with
                            </span>
                            </div>
                            <Button type="button" variant="default" className="w-full border-0 bg-accent/60 hover:bg-accent text-foreground">
                        ...
                        <div className="text-center text-sm text-foreground/30">
                            ...
                            <Link href="/signup" className="underline underline-offset-6 bg-[var(--color-primary)]">
                                Sign up
                            </Link>
                        </div>
                        </form>
