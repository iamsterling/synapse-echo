...
import { ChartSpline, Circle, CircleX, Ellipsis, GitBranch, GitCommitVertical, Github, Link as LinkIcon, Pencil, SquareArrowOutUpRight, X } from "lucide-react";
                ...
                <CardTitle className={cx("px-4 flex gap-2")}>
                    ...
                    <section className={cx("flex items-center gap-4")}>
                        ...
                        <Drawer>
                            ...
                            <DrawerContent className={cx("self-center place-self-center w-full")}>
                            <DrawerHeader>
